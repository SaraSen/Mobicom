...
<meta charset="utf-8" />
<title>Mobicom® CRM | Dashboard </title>
          ...
          <div class="col-md-3 col-sm-6 spacing-bottom-sm spacing-bottom">
            <div class="tiles  added-margin">
              <div class="tiles-body">
				...
				?>
                <div class="heading"> <span class="animate-number" data-value="<?php echo $num;?>" data-animation-duration="100">0</span>| <a href="view-tickets.php" style="color:#FFF"> View Tickets </a></div>
